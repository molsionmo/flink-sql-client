...
public class ExceptionUtils {
     ...
     *
     * <p>See {@link org.apache.flink.util.ExceptionUtils#isJvmFatalError(Throwable)} for a list of fatal JVM errors.
     ...
     * See {@link org.apache.flink.util.ExceptionUtils#isJvmFatalError(Throwable)} for a definition of fatal errors.
     *
    ...
    /**
     * Rethrows the given {@code Throwable}, if it represents an error that is fatal to the JVM
     * or an out-of-memory error. See {@link org.apache.flink.util.ExceptionUtils#isJvmFatalError(Throwable)} for a
